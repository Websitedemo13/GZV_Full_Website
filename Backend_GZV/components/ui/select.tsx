...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-2 pl-8 pr-2 text-sm outline-none focus:bg-red-50 focus:text-red-950 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 hover:bg-gray-50 data-[highlighted]:bg-red-50 data-[highlighted]:text-red-950 dark:focus:bg-red-950/20 dark:focus:text-red-50 dark:hover:bg-gray-700 dark:data-[highlighted]:bg-red-950/20 dark:data-[highlighted]:text-red-50",
      className
    )}
    {...props}
  >
