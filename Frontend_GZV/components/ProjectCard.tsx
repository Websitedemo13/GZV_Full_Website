...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <Card className="group h-full overflow-hidden rounded-none border border-slate-200/90 bg-white shadow-[0_14px_34px_rgba(15,23,42,0.08)] transition-all duration-300 hover:-translate-y-1 hover:border-[#ed1c24]/40 hover:shadow-[0_24px_48px_rgba(8,47,87,0.16)] dark:border-neutral-700 dark:bg-neutral-900">
                      ...
                      {mentors.map((m, idx) => (
                        <Link key={idx} href={m.profile_link || "#"} className="group/item flex items-center gap-3">
                          ...
                          <div className="flex flex-col">
                            <span className="text-sm font-black leading-none text-slate-700 transition-colors group-hover/item:text-[#ed1c24]">
                              {m.name}
                            </span>
